...
class BookmarksRemoteDataSource @Inject constructor(
    ...
    override suspend fun getBookmarksOnce(uid: String): List<BookmarkDataRemote> = runCatching {
    ...
    override suspend fun toggleBookmark(uid: String, bookmark: BookmarkDataRemote): Result<Unit> = runCatching {
        val favRef = database
